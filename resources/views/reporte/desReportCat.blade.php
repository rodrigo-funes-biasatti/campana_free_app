...
<div class="row justify-content-center">
	...
	<div class="col-4">
		...
		<br>
		<caption>La siguiente tabla muestra todas las asistencias del evento seleccionado dependiendo su categoría (Normal/VIP).</caption>
		<br>
		<caption>EVENTO: {{$e->nombre}}</caption>
		<br>
		<caption>Categoría:@if($cat == 0) NORMAL @else VIP @endif</caption>
	</div>
</div>
				...
				<tr>
					...
					<td>	
						<div class="form-check">
							<input @if($asi->pagado == 1) checked @endif type="checkbox" class="form-check-input" id="noPago">
