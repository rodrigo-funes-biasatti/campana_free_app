	...
	<div class="row justify-content-center">
		<div class="col-md-6">
			<div class="card" style="width: 40vw;">
				...
				<div class="card-body">
					<form method="POST" action="{{ route('evento.update', $evento->idEvento) }}" aria-label="{{ __('Editar evento') }}" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="nombre" type="text" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" placeholder="{{ $evento->nombre }}" required autofocus>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="nombreArtista" type="text" class="form-control{{ $errors->has('nombreArtista') ? ' is-invalid' : '' }}" name="nombreArtista" placeholder="{{ $evento->nombreArtista }}" required autofocus>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="fecha" type="date" class="form-control{{ $errors->has('fecha') ? ' is-invalid' : '' }}" name="fecha" value="{{ $evento->fecha }}" max="3000-12-31"min="{{\Carbon\Carbon::now()->format('Y-m-d')}}" required autofocus>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								...
								<input style="width: 70px;" class="form-control" type="number" min="00" max="23" name="hora" placeholder="{{$evento->hora}}">
								...
								<div class="col-md-6">
									...
									<input type="number" min="00" max="59" class="form-control" style="width: 70px;" name="minutos" placeholder="{{$evento->minutos}}">
							...
							<div class="form-group row">
								...
								<div class="col-md-5" style="padding:0px;">		
									<input id="preNormal" type="text" class="form-control{{ $errors->has('preNormal') ? ' is-invalid' : '' }}" name="preNormal" placeholder="{{ $evento->preNormal }}" required>
							...
							<div class="form-group row">
								...
								<div class="col-md-5" style="padding:0px;">		
									<input id="preVip" type="text" class="form-control{{ $errors->has('preVip') ? ' is-invalid' : '' }}" name="preVip" placeholder="{{ $evento->preVip }}" required>
							...
							<div class="form-group row mb-0">
								<div class="col-md-6 offset-md-5">
									<button onclick="return confirm('¿Confirmas la edición del evento?');" type="submit" class="btn btn-primary">
										{{ __('Editar evento') }}
									</button>
								</div>
							</div>
